...
let bossThemeSound1 = new Howl({
    src: [' ./src/sounds/enemyTheme1.mp3'],
    loop: true,
    volume: 0.3
});
let bossThemeSound2= new Howl({
    src: [' ./src/sounds/enemyTheme2.mp3'],
    loop: true,
    volume: 0.5
});
let bossThemeSound3 = new Howl({
    src: [' ./src/sounds/enemyTheme3.mp3'],
    loop: true,
    volume: 0.4
});
let coffeeSound = new Howl({
    src: [' ./src/sounds/coffeeSounds.mp3'],
    volume: 0.4
});
let eatingSound = new Howl({
    src: [' ./src/sounds/eatingSound.mp3'],
    volume: 0.4
});
...
let girlLaughSound = new Howl({
    src: [' ./src/sounds/girlLaugh.mp3'],
    volume: 1
});
let natureSound = new Howl({
    src: [' ./src/sounds/natureSound.mp3'],
    volume: 0.2
});
let punchingSound = new Howl({
    src: [' ./src/sounds/punch1.mp3'],
    volume: 0.8
});
let sunshineSound = new Howl({
    src: [' ./src/sounds/sunshineSound.mp3'],
    volume: 0.2
});
let potionSound = new Howl({
    src: [' ./src/sounds/potionSound.mp3'],
    volume: 0.2
});
let searchingSound1 = new Howl({
    src: [' ./src/sounds/searchingSound1.mp3'],
    loop: true,
    volume: 0.4
});
let searchingSound2 = new Howl({
    src: [' ./src/sounds/searchingSound2.mp3'],
    loop: true,
    volume: 0.4
});
let searchingSound3 = new Howl({
    src: [' ./src/sounds/searchingSound3.mp3'],
    loop: true,
    volume: 0.4
});
let screamSound = new Howl({
    src: [' ./src/sounds/scream.mp3'],
    volume: 0.7
});
let weaponPickupSound = new Howl({
    src: [' ./src/sounds/weaponPickup.mp3'],
    volume: 0.2
});
let winningThemeSound = new Howl({
    src: [' ./src/sounds/winningTheme.mp3'],
    volume: 0.4,
    loop: true
});
